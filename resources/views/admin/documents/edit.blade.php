    ...
    <div class="space-y-6">
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-xl font-semibold text-gray-900">Edit Document</h2>
                    <p class="mt-1 text-sm text-gray-500">Update document information and settings.</p>
                </div>
                <div class="flex items-center space-x-3">
                    <a href="{{ route('admin.documents.show', $document) }}" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors">
                        ← Back to Document
                    </a>
                </div>
            </div>
                    ...
                    <div>
                        ...
                        <select id="type" name="type" required 
                            ...
                            @foreach($types as $value => $label)
                                <option value="{{ $value }}" {{ $document->type == $value ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <select id="event_id" name="event_id" 
                            ...
                            @foreach($events as $id => $title)
                                <option value="{{ $id }}" {{ $document->event_id == $id ? 'selected' : '' }}>
                                    {{ Str::limit($title, 50) }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="3"
                                  ...
                                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">{{ $document->description }}</textarea>
                    ...
                    <div class="text-center">
                        ...
                        <div class="mt-4">
                            <label for="file" class="cursor-pointer">
                                <span class="mt-2 block text-sm font-medium text-gray-900">
                                    Click to replace file or drag and drop
                                </span>
                        ...
                        <div class="mt-3 p-3 bg-gray-50 rounded-lg">
                            ...
                            <p class="text-xs text-gray-500">
                                Size: {{ $document->formatted_file_size }} | Type: {{ $document->file_type }}
                            </p>
                        </div>
