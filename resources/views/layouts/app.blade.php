        ...
        <div class="pl-64">
            <header class="sticky top-0 z-30 border-b border-gray-200 bg-white/95 backdrop-blur">
                <div class="flex h-16 items-center justify-between px-6">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span class="rounded-full bg-gradient-to-r from-violet-600 to-purple-600 px-3 py-0.5 text-xs font-medium text-white">{{ ucfirst(str_replace('_', ' ', Auth::user()->getRoleNames()->first() ?? 'user')) }}</span>
                    </div>
                </div>
            </header>
            ...
            <main class="p-6">
                ...
                <div class="fixed bottom-6 right-6 z-50 max-w-sm rounded-lg border border-gray-200 bg-white p-4 shadow-lg" role="alert">
                    <p class="font-semibold text-gray-900">Login Successful!</p>
